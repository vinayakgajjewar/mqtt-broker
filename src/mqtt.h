...
/*
 * The first byte in the fixed header.
 */
...
/*
 * DISCONNECT is not really an ACK but the format is the same.
 */
...
/*
 * Serialize/deserialize MQTT packets.
 */
...
/*
 * Utility functions to build packets.
 */
...
struct mqtt_publish *
mqtt_packet_publish(unsigned char, unsigned short, size_t, unsigned char *, size_t, unsigned char *);

/*
 * Release a heap-allocated packet.
 */
